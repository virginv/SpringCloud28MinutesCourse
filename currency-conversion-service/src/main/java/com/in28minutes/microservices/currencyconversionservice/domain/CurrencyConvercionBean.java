...
public class CurrencyConvercionBean {
	...
	public CurrencyConvercionBean() {
		super();
	}

	public CurrencyConvercionBean(Long id, String from, String to, BigDecimal conversionMultiple, BigDecimal quantity,
